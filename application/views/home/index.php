<ARTICLE>
	...
	<P>I purposefully tried to keep the design as minimalistic as possible, since it would appear that's where the tech scene is heading. I used <A href="http://colorschemedesigner.com/#">Color Scheme Designer</A> for inspiration.</P>
	...
	<H3>Tech Overview</H3>
	<P>A bit about CodeIgniter <A href="http://en.wikipedia.org/wiki/Codeigniter#CodeIgniter">Wikipedia</A>:</P>
	...
	<P>To balance out the website's CSS, I took advantage of Nicolas Gallagher's <A href="http://necolas.github.com/normalize.css/">Normalize.css</A> CSS fancy sheet.</P>
	<P>Like <A href="http://developer.yahoo.com/yui/reset/">YUI3 CSS Reset</A> and the like, Normalize tries to level the web developer's playing field from browser to browser. Unlike CSS resets though, normalize attempts to preserve common browser defaults, saving designers the trouble of having to apply styles to every single element to make them look proper.</P>
</ARTICLE>